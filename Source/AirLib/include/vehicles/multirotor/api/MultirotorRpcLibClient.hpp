...
public:
    ...
    MultirotorRpcLibClient* setBackPropellerControlSignal(const float& value, const std::string& vehicle_name = "");
    MultirotorRpcLibClient* moveByAngleZAsync(float pitch, float roll, float z, float yaw, float duration,
                                              const std::string& vehicle_name = "");
    MultirotorRpcLibClient* moveByAngleThrottleAsync(float pitch, float roll, float throttle, float yaw_rate,
